...
namespace IfcSharpLib
{
    internal static class TocMapping
    {
        ...
        private static readonly FrozenDictionary<string, Assign> DirectAssign = new Dictionary<string, Assign>
        {
            ...
            { "module.exported", (ref TableOfContents toc, PartitionSummaryData d) => toc.exported_modules = d },
            { "module.imported", (ref TableOfContents toc, PartitionSummaryData d) => toc.imported_modules = d },
            { "const.i64", (ref TableOfContents toc, PartitionSummaryData d) => toc.u64s = d },
            { "const.f64", (ref TableOfContents toc, PartitionSummaryData d) => toc.fps = d },
            { "const.str", (ref TableOfContents toc, PartitionSummaryData d) => toc.string_literals = d },
            { "pragma.state", (ref TableOfContents toc, PartitionSummaryData d) => toc.states = d },
            { "src.line", (ref TableOfContents toc, PartitionSummaryData d) => toc.lines = d },
            { "src.word", (ref TableOfContents toc, PartitionSummaryData d) => toc.words = d },
            { "src.sentence", (ref TableOfContents toc, PartitionSummaryData d) => toc.sentences = d },
            { "scope.desc", (ref TableOfContents toc, PartitionSummaryData d) => toc.scopes = d },
            { "scope.member", (ref TableOfContents toc, PartitionSummaryData d) => toc.entities = d },
            { "form.spec", (ref TableOfContents toc, PartitionSummaryData d) => toc.spec_forms = d },
            ...
            { ".msvc.trait.impl-pragmas", (ref TableOfContents toc, PartitionSummaryData d) => toc.implementation_pragmas = d },
        }.ToFrozenDictionary();
